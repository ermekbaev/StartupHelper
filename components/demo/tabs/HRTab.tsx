...
import { Card, Badge, AdBanner } from '@/components/ui';
...
export function HRTab() {
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      {/* HR Tasks */}
      <Card>
        <h2 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">Кадровые задачи</h2>
        <div className="space-y-2 sm:space-y-3">
          <div className="flex items-center space-x-2 sm:space-x-3">
            <input type="checkbox" defaultChecked className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600" />
            <span className="line-through text-gray-500 text-sm sm:text-base">Оформить трудовые договоры</span>
          </div>
          <div className="flex items-center space-x-2 sm:space-x-3">
            <input type="checkbox" className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600" />
            <span className="text-gray-900 text-sm sm:text-base">Провести инструктаж по ТБ</span>
          </div>
          <div className="flex items-center space-x-2 sm:space-x-3">
            <input type="checkbox" className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600" />
            <span className="text-gray-900 text-sm sm:text-base">Обновить данные воинского учёта</span>
          </div>
        </div>
      </Card>
